    ...
    <>   
      <canvas ref={backgroundCanvasRef} className="relative"/>
        ...
        >
          ...
          {/* Text */}
          <h1 className="z-20 text-md text-yellow-300 text-center font-bold uppercase tracking-widest">Shop New Releases</h1>
        ...
        >
          ...
          {/* Text */}
          <h1 className="z-20 text-md text-yellow-400 font-bold uppercase tracking-widest">Gallery</h1>
