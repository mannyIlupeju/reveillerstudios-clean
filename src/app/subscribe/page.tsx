    ...
    <section className="flex justify-center items-center min-h-screen">
     <div className='text-sm flex-col items-center border-8 border-red-600 p-8'>
       ...
       <div className='flex flex-col gap-2'>
         <h1 className='text-2xl'>Join the RVS community</h1>
       </div>
       <div className='flex flex-col gap-2 mt-4'>
         <p className='text-md'>Get 20% off your first order and be the first to know about exclusive drops, restocks and special offers - straight to your inbox</p>
       </div>
       <div className='flex flex-col lg:flex-row gap-4 my-4 '>
         <input
           ...
           className='text-zinc-800 p-2 border-zinc-800'
         />
         <input
           type='email'
           name='email'
